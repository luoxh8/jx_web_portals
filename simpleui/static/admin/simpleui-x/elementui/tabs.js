                    ...
                    barStyle: {
                        get: function get() {
                            ...
                            var sizeName       = [
                                'top',
                                'bottom'
                            ].indexOf(this.rootTabs.tabPosition) !== -1 ? 'width' : 'height';
                ...
                computed: {
                    navStyle: function navStyle() {
                        var dir = [
                            'top',
                            'bottom'
                        ].indexOf(this.rootTabs.tabPosition) !== -1 ? 'X' : 'Y';
                        return {
                ...
                methods: {
                    ...
                    scrollToActiveTab      : function scrollToActiveTab() {
                        ...
                        var isHorizontal      = [
                            'top',
                            'bottom'
                        ].indexOf(this.rootTabs.tabPosition) !== -1;
                                        ...
                                        'div',
                                        {
                                            'class': [
                                                ...
                                                stretch && [
                                                    'top',
                                                    'bottom'
                                                ].indexOf(this.rootTabs.tabPosition) !== -1 ? 'is-stretch' : ''
                                            ],
                                            ref    : 'nav',
                                            style  : navStyle,
                                            attrs  : {
