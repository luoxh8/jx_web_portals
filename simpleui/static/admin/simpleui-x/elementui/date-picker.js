                ...
                methods: {
                    ...
                    changeSelectionRange: function changeSelectionRange(step) {
                        var list    = [
                            0,
                            3
                        ].concat(this.showSeconds ? [6] : []);
                        var mapping = [
                            'hours',
                            'minutes'
                        ].concat(this.showSeconds ? ['seconds'] : []);
                ...
                methods: {
                    ...
                    handleEndChange  : function handleEndChange(event) {
                        ...
                        if (value) {
                            ...
                            var newValue      = [
                                this.picker.value && this.picker.value[0],
                                value
                            ];
                            this.picker.value = newValue;
                            if (this.isValidValue(newValue)) {
            ...
            var year_tablevue_type_script_lang_js_ = ({
                ...
                methods: {
                    getCellStyle        : function getCellStyle(year) {
                        ...
                        style.disabled = typeof this.disabledDate === 'function' ? year_tablevue_type_script_lang_js_datesInYear(year)
            ...
            var month_tablevue_type_script_lang_js_ = ({
                ...
                methods: {
                    ...
                    getCellStyle         : function getCellStyle(cell) {
                        ...
                        style.disabled   = typeof this.disabledDate === 'function' ? month_tablevue_type_script_lang_js_datesInMonth(year, month)
                            .every(this.disabledDate) : false;
                        style.current    = Object(util_["arrayFindIndex"])(Object(util_["coerceTruthyValueToArray"])(this.value), function (date) {
                ...
                methods: {
                    ...
                    emit                         : function emit(value) {
                        ...
                        if (!value) {
                            ...
                            this.$emit.apply(this, [
                                'pick',
                                this.showTime ? Object(date_util_["clearMilliseconds"])(value) : Object(date_util_["clearTime"])(value)
                            ].concat(args));
                        }
...
//
            ...
            var date_rangevue_type_script_lang_js_calcDefaultValue = function calcDefaultValue(defaultValue) {
                if (Array.isArray(defaultValue)) {
                    ...
                    return [
                        new Date(),
                        Object(date_util_["nextDate"])(new Date(), 1)
                    ];
                }
            };
            ...
            var date_rangevue_type_script_lang_js_ = ({
                ...
                computed: {
                    btnDisabled     : function btnDisabled() {
                        return !(this.minDate && this.maxDate && !this.selecting && this.isValidValue([
                            this.minDate,
                            this.maxDate
                        ]));
                    },
...
//
            ...
            var month_rangevue_type_script_lang_js_calcDefaultValue = function calcDefaultValue(defaultValue) {
                if (Array.isArray(defaultValue)) {
                    ...
                    return [
                        new Date(),
                        Object(date_util_["nextMonth"])(new Date())
                    ];
                }
            };
            /* harmony default export */
