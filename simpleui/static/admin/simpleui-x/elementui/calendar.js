...
// CONCATENATED MODULE: ./node_modules/_babel-loader@7.1.5@babel-loader/lib!./node_modules/_vue-loader@15.9.3@vue-loader/lib??vue-loader-options!./packages/calendar/src/date-table.vue?vue&type=script&lang=js&
            ...
            var date_tablevue_type_script_lang_js_ = ({
                ...
                computed: {
                    ...
                    rows               : function rows() {
                        ...
                        if (this.isInRange) {
                            ...
                            var currentMonthRange = Object(date_util_["range"])(end.getDate() - start.getDate() + 1)
                            ...
                            var prevMonthDays    = Object(date_util_["getPrevMonthLastDays"])(date, firstDay - firstDayOfWeek)
                                .map(function (day) {
                                    return {
                                        text: day,
                                        type: 'prev'
                            ...
                            var nextMonthDays    = Object(date_util_["range"])(42 - days.length)
                                .map(function (_, index) {
                                    return {
                                        text: index + 1,
                                        type: 'next'
                ...
                render: function render() {
                    ...
                    var thead = this.hideHeader ? null : h('thead', [
